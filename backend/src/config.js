...
const description = "Mingo Pack are a collection of 10,000 chubby flamingos from the Mingo Pack Group. Randomly genereated and carefully curated, every Mingo is individual an unique.";
...
const PRESALE_WHITELISTED_ADDRESSES = ["0x52202d2c7345aD57cD0456AD8eAfFE1DA28a360f",]; // only update if you want to manually set the whitelisted addresses
...
const GENERIC_DESCRIPTION = "Mingo!"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreidl34lck46qbett3rhr45c56rphliylbwzvylroi7v3a2j67pshka"; // Replace with your generic image that will display for all NFTs pre-reveal.
